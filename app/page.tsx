...
const basePath = '/cnno-1775112901949';
...
export default function Home() {
  ...
  const products = [{ n: 'OG Rolls', d: 'Indulge in our classic cinnamon rolls, carefully crafted with the finest ingredients and a touch of love, to provide a truly comforting experience. Our OG Rolls are the perfect blend of traditional flavors and modern techniques.', i: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&q=80', icon: 'domain' }, { n: 'Pistachio Rolls', d: 'Experience the rich flavor of pistachios infused in our signature cinnamon rolls, creating a delightful twist on a classic favorite. Our Pistachio Rolls are perfect for adventurous palates and nut lovers alike.', i: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1200&q=80', icon: 'architecture' }, { n: 'Chocolate Rolls', d: 'Treat yourself to the decadence of chocolate and cinnamon, as our Chocolate Rolls combine the finest dark chocolate with the warmth of cinnamon, creating a truly indulgent experience.', i: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=1200&q=80', icon: 'chair' }, { n: 'Baby Rolls', d: 'Bite-sized and utterly adorable, our Baby Rolls are the perfect snack for any time of day. These miniature cinnamon rolls are packed with flavor and sure to delight both kids and adults.', i: 'https://images.unsplash.com/photo-1504639725590-34d0984388bd?w=1200&q=80', icon: 'eco' }, { n: 'Party Box', d: 'Gather your friends and family, and celebrate with our Party Box, featuring an assortment of our delicious cinnamon rolls. This is the perfect solution for parties, events, and special occasions.', i: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1200&q=80', icon: 'precision_manufacturing' }];
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft exceptional cinnamon rolls that bring warmth and comfort to our community, while fostering a culture of quality, creativity, and customer satisfaction.</p>
                </div>
                <div className="space-y-2">
